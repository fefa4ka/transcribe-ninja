...
.controller( 'AuthModalCtrl', function AuthModalCtrl( $scope, $modalInstance, authCallback, $rootScope, api ) {
    ...
    $scope.passwordReset = function () {
        ...
        yaCounter30919251.reachGoal('password-reset');
    };
    ...
    $scope.authLogin = function() {
        var login = function () {
            ...
            api.auth.login({
                ...
                $scope.alerts = [{ type: 'danger', msg: 'Неправильный логин или пароль' }];
                 ...
                 // Ya.Metrica
                yaCounter30919251.reachGoal('login-fail');
            });
        };
        ...
        if($scope.new_user == 1) {
            api.auth.register({
                ...
                // Ya.Metrica
                yaCounter30919251.reachGoal('registration');
            }, function (data) {
                $scope.alerts = [{ type: 'danger', msg: 'Такой адрес уже зарегистрирован' }];

                // Ya.Metrica
                yaCounter30919251.reachGoal('registration-fail');
            });
            ...
            // Ya.Metrica
            yaCounter30919251.reachGoal('login');
        }
    };
