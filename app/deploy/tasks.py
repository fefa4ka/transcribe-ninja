...
configure_instance = [
    ...
    {"action": "run", "params":
        u"echo 'source %(ACTIVATE)' >> /home/%(EC2_SERVER_USERNAME)s/.profile"},
    ...
    {"action": "run", "params":
     """echo 'IdentityFile /home/%(SERVER_USERNAME)s/.ssh/%(GIT_KEY_NAME)s' >> /home/%(SERVER_USERNAME)s/.ssh/config"""},
    {"action": "run", "params":
