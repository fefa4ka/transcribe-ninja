...
class Queue(AudioFile):
    ...
    WORK_TYPE_CHOICES = (
        ...
        (EDIT, 'Check and edit'),
        (PRETTY, 'Pretty checked text'),
        (CHECK, 'Check pretty text')
    )
    ...
    def pieces(self):
        ...
        if self.work_type == self.CHECK:
            ...
            while next_piece and len(pieces) < 4:
                pieces.append(next_piece)

                next_piece = next_piece.next
    ...
    def transcriptions(self):
        return self._get_trancriptions()
    ...
    def audio_file_make(self, offset=0):
        """
